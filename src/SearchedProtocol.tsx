...
import styles from "./css/SearchedProtocols.module.css";

export const SearchedProtocol: FunctionComponent = () => {
  return (
    <div className={styles.dashboardDiv}>
      <img className={styles.icon24cursor} alt="" src="icon24cursor5.svg" />
      ...
      <div className={styles.groupDiv}>
        <img className={styles.rectangleIcon} alt="" src="rectangle-4581.svg" />
      ...
      <div className={styles.groupDiv21}>
        <div className={styles.groupDiv22}>
          <div className={styles.frameDiv11}>
            <img className={styles.groupIcon} alt="" src="group-610.svg" />
      ...
      <div className={styles.groupDiv23}>
        <div className={styles.groupDiv24}>
          <div className={styles.frameDiv11}>
            <img className={styles.groupIcon8} alt="" src="group-611.svg" />
            <b className={styles.cAKEB}>BNB/ETH</b>
          </div>
          <div className={styles.frameDiv12}>
            <img className={styles.groupIcon8} alt="" src="group-18.svg" />
            <b className={styles.cAKEB}>BNB/BTC</b>
          </div>
          <div className={styles.frameDiv13}>
            <img className={styles.groupIcon8} alt="" src="group-46.svg" />
      ...
      <div className={styles.groupDiv25}>
        <div className={styles.groupDiv26}>
          <div className={styles.frameDiv11}>
            <img className={styles.groupIcon} alt="" src="group-612.svg" />
            <b className={styles.cAKEB}>Uniswap</b>
          </div>
          <div className={styles.frameDiv12}>
            <img className={styles.groupIcon} alt="" src="group-19.svg" />
            <b className={styles.cAKEB}>1Inch</b>
          </div>
          <div className={styles.frameDiv13}>
            <img className={styles.groupIcon} alt="" src="group-47.svg" />
      ...
      <div className={styles.frameDiv41}>
        ...
        <img className={styles.frameIcon1} alt="" src="frame-10000020688.svg" />
        <div className={styles.buttonDiv8}>
          <div className={styles.groupDiv29}>
            <div className={styles.aggregateDiv}>Enter Protocol</div>
          </div>
        </div>
        <img
          className={styles.rectangleIcon1}
          alt=""
          src="rectangle-150884.svg"
        />
        ...
        <b className={styles.balancer2}>Balancer</b>
